...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:sticky top-16 left-0 h-[calc(100vh-4rem)] bg-white border-r border-gray-200 z-30 transform transition-all duration-300 ease-in-out ${
          isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
        } md:w-64 w-3/4 md:block overflow-y-auto`}
      >
        <div className="p-4">
          {/* Role indicator */}
